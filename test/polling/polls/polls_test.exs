defmodule Polling.PollsTest do
  use Polling.DataCase
  ...
  describe "polls" do
    ...
    @valid_attrs %{description: "some description", down_votes: 42, up_votes: 42}
    @update_attrs %{description: "some updated description", down_votes: 43, up_votes: 43}
    @invalid_attrs %{description: nil, down_votes: nil, up_votes: nil}
    ...
    test "create_poll/1 with valid data creates a poll" do
      ...
      assert poll.down_votes == 42
      assert poll.up_votes == 42
    end
    ...
    test "update_poll/2 with valid data updates the poll" do
      ...
      assert poll.down_votes == 43
      assert poll.up_votes == 43
    end
